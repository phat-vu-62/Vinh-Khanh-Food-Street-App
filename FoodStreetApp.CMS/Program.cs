...
using (var scope = app.Services.CreateScope())
{
    try
    {
        ...
        Console.WriteLine("[DB] Ensuring database created...");
        dbContext.Database.EnsureCreated();
        
        // Define all required columns and tables in a cleaner way
        var sqlInit = @"
        ...
        dbContext.Database.ExecuteSqlRaw(sqlInit);
        Console.WriteLine("[DB] Database initialization complete.");
    }
    catch (Exception ex)
    {
        Console.WriteLine($"[DB Error] Startup sync failed: {ex.Message}");
    }
}
